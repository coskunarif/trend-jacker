...
4. Commit and push the verified changes to GitHub (Conventional Commits e.g. 'feat: ...', 'fix: ...', 'docs: ...', followed by 'git push origin main'). This will trigger the automated GitHub Actions CI/CD deployment.
5. Monitor and confirm the GitHub Actions workflow run succeeds (check 'gh run list' or the Actions tab).
